...
"tools/"{__init__,dochelpers,qubes_prefs,qvm_backup,qvm_backup_restore,qvm_clone,qvm_create,qvm_device,qvm_features,qvm_firewall,qvm_kill,qvm_ls,qvm_notes,qvm_pause}".py"
)
